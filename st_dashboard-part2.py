...
if page == "Intro page":
    ...
    myImage = Image.open("/users/gideon/DivvyBikes_2022/DivvyImage.jpeg") 
    st.image(myImage)
...
### Most popular stations page
    ...
    # )
    # st.plotly_chart(fig, use_container_width=True)
    st.markdown("From the bar chart it is clear that there are some start stations that are more popular than others - in the top 3 we can see Streeter Drive/Grand Avenue, Canal Street/Adams Street as well as Clinton Street/Madison Street. There is a big jump between the highest and lowest bars of the plot indicating some clear preferences for the leading stations. This is a finding that we could cross reference with the interactive map that you can access through the side bar select box.")
